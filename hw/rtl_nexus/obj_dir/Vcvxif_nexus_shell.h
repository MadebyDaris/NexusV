...
#ifndef VERILATED_VCVXIF_NEXUS_SHELL_H_
#define VERILATED_VCVXIF_NEXUS_SHELL_H_  // guard

#include "verilated.h"

class Vcvxif_nexus_shell__Syms;
class Vcvxif_nexus_shell___024root;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) Vcvxif_nexus_shell VL_NOT_FINAL : public VerilatedModel {
  private:
    // Symbol table holding complete model state (owned by this class)
    Vcvxif_nexus_shell__Syms* const vlSymsp;
  ...
  public:
    ...
    Vcvxif_nexus_shell___024root* const rootp;
    ...
    explicit Vcvxif_nexus_shell(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vcvxif_nexus_shell(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vcvxif_nexus_shell();
  private:
    VL_UNCOPYABLE(Vcvxif_nexus_shell);  ///< Copying not allowed
